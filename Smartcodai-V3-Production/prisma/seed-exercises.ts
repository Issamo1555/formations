...
const exercises: Record<string, Record<number, ExerciseData>> = {
  ...
  php: {
    1: {
      exerciseFr: `<?php\n// Exercice 1: Ecrivez votre premier programme PHP\n// Affichez un message de bienvenue\necho "Bienvenue sur Smartcodai!";\n\n// Affichez votre nom et age en utilisant des variables\n$prenom = "Alice";\n$age = 25;\necho "\\nJe m'appelle " . $prenom . " et j'ai " . $age . " ans.";\n?>`,
      exerciseEn: `<?php\n// Exercise 1: Write your first PHP program\n// Display a welcome message\necho "Welcome to Smartcodai!";\n\n// Display your name and age using variables\n$name = "Alice";\n$age = 25;\necho "\\nMy name is " . $name . " and I am " . $age . " years old.";\n?>`,
      exerciseAr: `<?php\n// التمرين 1: اكتب أول برنامج PHP لك\n// اعرض رسالة ترحيب\necho "مرحباً بك في Smartcodai!";\n\n// اعرض اسمك وعمرك باستخدام المتغيرات\n$name = "أليس";\necho "\\nاسمي " . $name;\n?>`,
    },
    2: {
      exerciseFr: `<?php\n// Exercice 2: Les Commentaires\n// Ajoutez des commentaires pour expliquer chaque ligne\n\n// TODO: Declarez une variable pour le prix\n$prix = 29.99;\n\n// TODO: Declarez une variable pour la quantite\n$quantite = 3;\n\n// TODO: Calculez le total\n$total = $prix * $quantite;\n\n// TODO: Affichez le resultat\necho "Prix unitaire: " . $prix . " euros\\n";\necho "Quantite: " . $quantite . "\\n";\necho "Total: " . $total . " euros\\n";\n?>`,
      exerciseEn: `<?php\n// Exercise 2: Comments\n// Add comments to explain each line\n\n// TODO: Declare a variable for the price\n$price = 29.99;\n\n// TODO: Declare a variable for the quantity\n$quantity = 3;\n\n// TODO: Calculate the total\n$total = $price * $quantity;\n\n// TODO: Display the result\necho "Unit price: " . $price . " dollars\\n";\necho "Quantity: " . $quantity . "\\n";\necho "Total: " . $total . " dollars\\n";\n?>`,
      exerciseAr: `<?php\n// التمرين 2: التعليقات\n// أضف تعليقات لشرح كل سطر\n\n// TODO: أعلن متغير للسعر\n$price = 29.99;\n\n// TODO: أعلن متغير للكمية\n$quantity = 3;\n\necho "السعر: " . $price . " دولار\\n";\necho "الكمية: " . $quantity . "\\n";\n?>`,
    },
    3: {
      exerciseFr: `<?php\n// Exercice 3: Les Constantes\n// Definissez et utilisez des constantes\n\n// TODO: Definissez une constante pour le taux TVA\ndefine("TAUX_TVA", 0.20);\n\n// TODO: Definissez une constante pour la devise\ndefine("DEVISE", " euros");\n\n// TODO: Calculez le prix TTC d'un produit\n$prixHT = 100;\n$prixTTC = $prixHT * (1 + TAUX_TVA);\n\necho "Prix HT: " . $prixHT . DEVISE . "\\n";\necho "TVA: " . (TAUX_TVA * 100) . "%\\n";\necho "Prix TTC: " . $prixTTC . DEVISE . "\\n";\n?>`,
      exerciseEn: `<?php\n// Exercise 3: Constants\n// Define and use constants\n\n// TODO: Define a constant for the tax rate\ndefine("TAX_RATE", 0.20);\n\n// TODO: Define a constant for the currency\ndefine("CURRENCY", " dollars");\n\n// TODO: Calculate the total price with tax\n$priceWithoutTax = 100;\n$priceWithTax = $priceWithoutTax * (1 + TAX_RATE);\n\necho "Price without tax: " . $priceWithoutTax . CURRENCY . "\\n";\necho "Tax: " . (TAX_RATE * 100) . "%\\n";\necho "Price with tax: " . $priceWithTax . CURRENCY . "\\n";\n?>`,
      exerciseAr: `<?php\n// التمرين 3: الثوابت\n// تعريف واستخدام الثوابت\n\ndefine("TAX_RATE", 0.20);\ndefine("CURRENCY", " دولار");\n\n$price = 100;\n$priceWithTax = $price * (1 + TAX_RATE);\n\necho "السعر بدون ضريبة: " . $price . CURRENCY . "\\n";\necho "الضريبة: " . (TAX_RATE * 100) . "%\\n";\n?>`,
    },
    4: {
      exerciseFr: `<?php\n// Exercice 4: Les Variables\n// Manipulez les variables et leurs types\n\n// TODO: Declarez different types de variables\n$prenom = "Bob";\n$age = 30;\n$taille = 1.75;\n$estDeveloppeur = true;\n\n// TODO: Affichez chaque variable avec son type\necho "Prenom: " . $prenom . " (type: " . gettype($prenom) . ")\\n";\necho "Age: " . $age . " (type: " . gettype($age) . ")\\n";\necho "Taille: " . $taille . "m (type: " . gettype($taille) . ")\\n";\necho "Developpeur: " . ($estDeveloppeur ? "Oui" : "Non") . " (type: " . gettype($estDeveloppeur) . ")\\n";\n?>`,
      exerciseEn: `<?php\n// Exercise 4: Variables\n// Manipulate variables and their types\n\n// TODO: Declare different types of variables\n$name = "Bob";\n$age = 30;\n$height = 1.75;\n$isDeveloper = true;\n\n// TODO: Display each variable with its type\necho "Name: " . $name . " (type: " . gettype($name) . ")\\n";\necho "Age: " . $age . " (type: " . gettype($age) . ")\\n";\necho "Height: " . $height . "m (type: " . gettype($height) . ")\\n";\necho "Developer: " . ($isDeveloper ? "Yes" : "No") . " (type: " . gettype($isDeveloper) . ")\\n";\n?>`,
      exerciseAr: `<?php\n// التمرين 4: المتغيرات\n// التعامل مع المتغيرات وأنواعها\n\n// TODO: أعلن أنواع مختلفة من المتغيرات\n$name = "بوب";\n$age = 30;\n\necho "الاسم: " . $name . " (النوع: " . gettype($name) . ")\\n";\necho "العمر: " . $age . " (النوع: " . gettype($age) . ")\\n";\n?>`,
    },
    5: {
      exerciseFr: `<?php\n// Exercice 5: Les Tableaux (Arrays)\n// Creez et manipulez des tableaux\n\n// TODO: Creez un tableau de fruits\n$fruits = ["Pomme", "Banane", "Cerise", "Datte"];\n\n// TODO: Affichez le nombre d'elements\necho "Nombre de fruits: " . count($fruits) . "\\n";\n\n// TODO: Ajoutez un nouveau fruit\n$fruits[] = "Mangue";\n\n// TODO: Affichez chaque fruit avec une boucle\necho "Liste des fruits:\\n";\nforeach ($fruits as $index => $fruit) {\n    echo ($index + 1) . ". " . $fruit . "\\n";\n}\n\n// TODO: Triez le tableau\nsort($fruits);\necho "\\nFruits tries: " . implode(", ", $fruits) . "\\n";\n?>`,
      exerciseEn: `<?php\n// Exercise 5: Arrays\n// Create and manipulate arrays\n\n// TODO: Create an array of fruits\n$fruits = ["Apple", "Banana", "Cherry", "Date"];\n\n// TODO: Display the number of elements\necho "Number of fruits: " . count($fruits) . "\\n";\n\n// TODO: Add a new fruit\n$fruits[] = "Mango";\n\n// TODO: Display each fruit with a loop\necho "List of fruits:\\n";\nforeach ($fruits as $index => $fruit) {\n    echo ($index + 1) . ". " . $fruit . "\\n";\n}\n\n// TODO: Sort the array\nsort($fruits);\necho "\\nSorted fruits: " . implode(", ", $fruits) . "\\n";\n?>`,
      exerciseAr: `<?php\n// التمرين 5: المصفوفات\n// إنشاء والتعامل مع المصفوفات\n\n// TODO: أنشئ مصفوفة من الفواكه\n$fruits = ["تفاحة", "موزة", "كرز"];\n\necho "عدد الفواكه: " . count($fruits) . "\\n";\n\n$fruits[] = "مانجو";\n\nforeach ($fruits as $fruit) {\n    echo $fruit . "\\n";\n}\n?>`,
    },
    6: {
      exerciseFr: `<?php\n// Exercice 6: Les Operateurs\n// Testez differents operateurs\n\n// TODO: Operateurs arithmetiques\n$a = 15;\n$b = 4;\n\necho "a = " . $a . ", b = " . $b . "\\n";\necho "Addition: " . ($a + $b) . "\\n";\necho "Soustraction: " . ($a - $b) . "\\n";\necho "Multiplication: " . ($a * $b) . "\\n";\necho "Division: " . ($a / $b) . "\\n";\necho "Modulo: " . ($a % $b) . "\\n";\necho "Puissance: " . ($a ** $b) . "\\n";\n\n// TODO: Operateurs de comparaison\n$x = 10;\n$y = "10";\n\necho "\\nx == y (egal): " . ($x == $y ? "Oui" : "Non") . "\\n";\necho "x === y (identique): " . ($x === $y ? "Oui" : "Non") . "\\n";\n?>`,
      exerciseEn: `<?php\n// Exercise 6: Operators\n// Test different operators\n\n// TODO: Arithmetic operators\n$a = 15;\n$b = 4;\n\necho "a = " . $a . ", b = " . $b . "\\n";\necho "Addition: " . ($a + $b) . "\\n";\necho "Subtraction: " . ($a - $b) . "\\n";\necho "Multiplication: " . ($a * $b) . "\\n";\necho "Division: " . ($a / $b) . "\\n";\necho "Modulo: " . ($a % $b) . "\\n";\necho "Power: " . ($a ** $b) . "\\n";\n\n// TODO: Comparison operators\n$x = 10;\n$y = "10";\n\necho "\\nx == y (equal): " . ($x == $y ? "Yes" : "No") . "\\n";\necho "x === y (identical): " . ($x === $y ? "Yes" : "No") . "\\n";\n?>`,
      exerciseAr: `<?php\n// التمرين 6: العوامل\n// اختبار عوامل مختلفة\n\n$a = 15;\n$b = 4;\n\necho "a = " . $a . ", b = " . $b . "\\n";\necho "الجمع: " . ($a + $b) . "\\n";\necho "الطرح: " . ($a - $b) . "\\n";\necho "الضرب: " . ($a * $b) . "\\n";\necho "القسمة: " . ($a / $b) . "\\n";\n?>`,
    },
    7: {
      exerciseFr: `<?php\n// Exercice 7: Conditions & Switch\n// Utilisez des conditions et switch\n\n// TODO: Verifiez l'age d'une personne\n$age = 20;\n\nif ($age < 13) {\n    echo "Enfant\\n";\n} elseif ($age < 18) {\n    echo "Adolescent\\n";\n} elseif ($age < 65) {\n    echo "Adulte\\n";\n} else {\n    echo "Senior\\n";\n}\n\n// TODO: Utilisez switch pour le jour de la semaine\n$jour = "Lundi";\n\nswitch ($jour) {\n    case "Lundi":\n    case "Mardi":\n    case "Mercredi":\n    case "Jeudi":\n    case "Vendredi":\n        echo $jour . " : Jour de travail\\n";\n        break;\n    case "Samedi":\n    case "Dimanche":\n        echo $jour . " : Week-end!\\n";\n        break;\n    default:\n        echo "Jour inconnu\\n";\n}\n?>`,
      exerciseEn: `<?php\n// Exercise 7: Conditions & Switch\n// Use conditions and switch\n\n// TODO: Check a person's age\n$age = 20;\n\nif ($age < 13) {\n    echo "Child\\n";\n} elseif ($age < 18) {\n    echo "Teenager\\n";\n} elseif ($age < 65) {\n    echo "Adult\\n";\n} else {\n    echo "Senior\\n";\n}\n\n// TODO: Use switch for day of the week\n$day = "Monday";\n\nswitch ($day) {\n    case "Monday":\n    case "Tuesday":\n    case "Wednesday":\n    case "Thursday":\n    case "Friday":\n        echo $day . ": Workday\\n";\n        break;\n    case "Saturday":\n    case "Sunday":\n        echo $day . ": Weekend!\\n";\n        break;\n    default:\n        echo "Unknown day\\n";\n}\n?>`,
      exerciseAr: `<?php\n// التمرين 7: الشروط و Switch\n// استخدام الشروط و switch\n\n$age = 20;\n\nif ($age < 13) {\n    echo "طفل\\n";\n} elseif ($age < 18) {\n    echo "مراهق\\n";\n} else {\n    echo "بالغ\\n";\n}\n\n$day = "الاثنين";\nswitch ($day) {\n    case "السبت":\n    case "الأحد":\n        echo "عطلة نهاية الأسبوع!\\n";\n        break;\n    default:\n        echo "يوم عمل\\n";\n}\n?>`,
    },
    8: {
      exerciseFr: `<?php\n// Exercice 8: Les Boucles\n// Pratiquez les differentes boucles\n\n// TODO: Boucle for - Affichez les 10 premiers nombres\necho "Nombres de 1 a 10:\\n";\nfor ($i = 1; $i <= 10; $i++) {\n    echo $i . " ";\n}\necho "\\n";\n\n// TODO: Boucle while - Compte a rebours\necho "\\nCompte a rebours:\\n";\n$n = 5;\nwhile ($n > 0) {\n    echo $n . " ";\n    $n--;\n}\necho "\\n";\n\n// TODO: Boucle foreach - Parcourez un tableau associa\teif\n$person = [\n    "nom" => "Alice",\n    "age" => 25,\n    "ville" => "Paris"\n];\n\necho "\\nInformations:\\n";\nforeach ($person as $cle => $valeur) {\n    echo $cle . ": " . $valeur . "\\n";\n}\n?>`,
      exerciseEn: `<?php\n// Exercise 8: Loops\n// Practice different loops\n\n// TODO: For loop - Display first 10 numbers\necho "Numbers 1 to 10:\\n";\nfor ($i = 1; $i <= 10; $i++) {\n    echo $i . " ";\n}\necho "\\n";\n\n// TODO: While loop - Countdown\necho "\\nCountdown:\\n";\n$n = 5;\nwhile ($n > 0) {\n    echo $n . " ";\n    $n--;\n}\necho "\\n";\n\n// TODO: Foreach loop - Iterate over associative array\n$person = [\n    "name" => "Alice",\n    "age" => 25,\n    "city" => "Paris"\n];\n\necho "\\nInformation:\\n";\nforeach ($person as $key => $value) {\n    echo $key . ": " . $value . "\\n";\n}\n?>`,
      exerciseAr: `<?php\n// التمرين 8: الحلقات\n// ممارسة الحلقات المختلفة\n\n// TODO: حلقة for - اعرض الأرقام من 1 إلى 10\necho "الأرقام من 1 إلى 10:\\n";\nfor ($i = 1; $i <= 10; $i++) {\n    echo $i . " ";\n}\necho "\\n";\n\n// TODO: حلقة while - العد التنازلي\n$n = 5;\nwhile ($n > 0) {\n    echo $n . " ";\n    $n--;\n}\n?>`,
    },
    9: {
      exerciseFr: `<?php\n// Exercice 9: Formulaires GET/POST\n// Simulez la reception de donnees formulaire\n\n// TODO: Simulez des donnees POST (comme si elles venaient d'un formulaire)\n$_SERVER["REQUEST_METHOD"] = "POST";\n$_POST["nom"] = "Dupont";\n$_POST["email"] = "dupont@email.com";\n$_POST["message"] = "Bonjour, je voudrais plus d'informations.";\n\n// TODO: Traitez les donnees du formulaire\nif ($_SERVER["REQUEST_METHOD"] === "POST") {\n    $nom = htmlspecialchars($_POST["nom"]);\n    $email = htmlspecialchars($_POST["email"]);\n    $message = htmlspecialchars($_POST["message"]);\n    \n    echo "=== Message Recu ===\\n";\n    echo "De: " . $nom . "\\n";\n    echo "Email: " . $email . "\\n";\n    echo "Message: " . $message . "\\n";\n    \n    // Verification basique\n    if (empty($nom) || empty($email)) {\n        echo "\\nErreur: Tous les champs sont obligatoires!\\n";\n    } else {\n        echo "\\nMessage envoye avec succes!\\n";\n    }\n}\n?>`,
      exerciseEn: `<?php\n// Exercise 9: GET/POST Forms\n// Simulate receiving form data\n\n// TODO: Simulate POST data (as if from a form)\n$_SERVER["REQUEST_METHOD"] = "POST";\n$_POST["name"] = "Smith";\n$_POST["email"] = "smith@email.com";\n$_POST["message"] = "Hello, I would like more information.";\n\n// TODO: Process form data\nif ($_SERVER["REQUEST_METHOD"] === "POST") {\n    $name = htmlspecialchars($_POST["name"]);\n    $email = htmlspecialchars($_POST["email"]);\n    $message = htmlspecialchars($_POST["message"]);\n    \n    echo "=== Message Received ===\\n";\n    echo "From: " . $name . "\\n";\n    echo "Email: " . $email . "\\n";\n    echo "Message: " . $message . "\\n";\n    \n    // Basic validation\n    if (empty($name) || empty($email)) {\n        echo "\\nError: All fields are required!\\n";\n    } else {\n        echo "\\nMessage sent successfully!\\n";\n    }\n}\n?>`,
      exerciseAr: `<?php\n// التمرين 9: نماذج GET/POST\n// محاكاة استقبال بيانات النموذج\n\n$_SERVER["REQUEST_METHOD"] = "POST";\n$_POST["name"] = "سميث";\n$_POST["email"] = "smith@email.com";\n\nif ($_SERVER["REQUEST_METHOD"] === "POST") {\n    $name = htmlspecialchars($_POST["name"]);\n    $email = htmlspecialchars($_POST["email"]);\n    \n    echo "=== الرسالة المستلمة ===\\n";\n    echo "من: " . $name . "\\n";\n    echo "البريد: " . $email . "\\n";\n}\n?>`,
    },
    10: {
      exerciseFr: `<?php\n// Exercice 10: Les Cookies\n// Creez et lisez des cookies\n\n// TODO: Simulez un cookie\necho "=== Test des Cookies ===\\n";\n\n// Fonction pour simuler setcookie\nfunction definirCookie($nom, $valeur, $duree = 3600) {\n    echo "Cookie defini: " . $nom . " = " . $valeur . " (expire dans " . $duree . "s)\\n";\n}\n\n// TODO: Creez un cookie de session utilisateur\ndefinirCookie("user_id", "12345", 3600);\ndefinirCookie("user_name", "Alice", 3600);\ndefinirCookie("theme", "dark", 86400);\n\n// TODO: Simulez la lecture des cookies\n$cookies = [\n    "user_id" => "12345",\n    "user_name" => "Alice",\n    "theme" => "dark"\n];\n\necho "\\n=== Cookies Lus ===\\n";\nforeach ($cookies as $nom => $valeur) {\n    echo $nom . ": " . $valeur . "\\n";\n}\n?>`,
      exerciseEn: `<?php\n// Exercise 10: Cookies\n// Create and read cookies\n\n// TODO: Simulate a cookie\necho "=== Cookie Test ===\\n";\n\n// Function to simulate setcookie\nfunction defineCookie($name, $value, $duration = 3600) {\n    echo "Cookie set: " . $name . " = " . $value . " (expires in " . $duration . "s)\\n";\n}\n\n// TODO: Create a user session cookie\ndefineCookie("user_id", "12345", 3600);\ndefineCookie("user_name", "Alice", 3600);\ndefineCookie("theme", "dark", 86400);\n\n// TODO: Simulate reading cookies\n$cookies = [\n    "user_id" => "12345",\n    "user_name" => "Alice",\n    "theme" => "dark"\n];\n\necho "\\n=== Cookies Read ===\\n";\nforeach ($cookies as $name => $value) {\n    echo $name . ": " . $value . "\\n";\n}\n?>`,
      exerciseAr: `<?php\n// التمرين 10: ملفات تعريف الارتباط (Cookies)\n// إنشاء وقراءة الكوكيز\n\necho "=== اختبار الكوكيز ===\\n";\n\nfunction defineCookie($name, $value, $duration = 3600) {\n    echo "تم تعيين الكوكي: " . $name . " = " . $value . "\\n";\n}\n\ndefineCookie("user_id", "12345", 3600);\ndefineCookie("user_name", "أليس", 3600);\necho "\\nتم قراءة الكوكيز بنجاح!\\n";\n?>`,
    },
    11: {
      exerciseFr: `<?php\n// Exercice 11: Les Sessions\n// Simulez un systeme de connexion\n\n// TODO: Demarrez une session (simulee)\necho "=== Systeme de Connexion ===\\n";\n\n// Simulez des donnees de session\n$session = [];\n\n// Fonction login\nfunction login(&$session, $username) {\n    $session["logged_in"] = true;\n    $session["username"] = $username;\n    $session["login_time"] = date("Y-m-d H:i:s");\n    echo $username . " s'est connecte!\\n";\n}\n\n// Fonction logout\nfunction logout(&$session) {\n    $user = $session["username"] ?? "Utilisateur";\n    $session = [];\n    echo $user . " s'est deconnecte.\\n";\n}\n\n// Fonction pour afficher le statut\nfunction afficherStatut($session) {\n    if ($session["logged_in"] ?? false) {\n        echo "Connecte en tant que: " . $session["username"] . "\\n";\n        echo "Depuis: " . $session["login_time"] . "\\n";\n    } else {\n        echo "Non connecte\\n";\n    }\n}\n\n// Testez les fonctions\nlogin($session, "Alice");\nafficherStatut($session);\necho "\\n";\nlogout($session);\nafficherStatut($session);\n?>`,
      exerciseEn: `<?php\n// Exercise 11: Sessions\n// Simulate a login system\n\n// TODO: Start a session (simulated)\necho "=== Login System ===\\n";\n\n// Simulate session data\n$session = [];\n\n// Login function\nfunction login(&$session, $username) {\n    $session["logged_in"] = true;\n    $session["username"] = $username;\n    $session["login_time"] = date("Y-m-d H:i:s");\n    echo $username . " logged in!\\n";\n}\n\n// Logout function\nfunction logout(&$session) {\n    $user = $session["username"] ?? "User";\n    $session = [];\n    echo $user . " logged out.\\n";\n}\n\n// Display status function\nfunction displayStatus($session) {\n    if ($session["logged_in"] ?? false) {\n        echo "Logged in as: " . $session["username"] . "\\n";\n        echo "Since: " . $session["login_time"] . "\\n";\n    } else {\n        echo "Not logged in\\n";\n    }\n}\n\n// Test the functions\nlogin($session, "Alice");\ndisplayStatus($session);\necho "\\n";\nlogout($session);\ndisplayStatus($session);\n?>`,
      exerciseAr: `<?php\n// التمرين 11: الجلسات (Sessions)\n// محاكاة نظام تسجيل الدخول\n\necho "=== نظام تسجيل الدخول ===\\n";\n\n$session = [];\n\nfunction login(&$session, $username) {\n    $session["logged_in"] = true;\n    $session["username"] = $username;\n    echo $username . " سجل دخوله!\\n";\n}\n\nfunction logout(&$session) {\n    $session = [];\n    echo "تم تسجيل الخروج.\\n";\n}\n\nlogin($session, "أليس");\necho "متصل بـ: " . $session["username"] . "\\n";\nlogout($session);\n?>`,
    },
    12: {
      exerciseFr: `<?php\n// Exercice 12: require() & include()\n// Simulez l'inclusion de fichiers\n\n// TODO: Creez un fichier simule de configuration\n$config = [\n    "site_name" => "MonSite",\n    "db_host" => "localhost",\n    "db_name" => "ma_base",\n    "version" => "1.0"\n];\n\n// Simulez require\nfunction requireFile($file) {\n    echo "Chargement de: " . $file . "\\n";\n    return true;\n}\n\n// Simulez include\nfunction includeFile($file) {\n    echo "Inclusion de: " . $file . "\\n";\n    return true;\n}\n\n// Testez les inclusions\necho "=== Test d'Inclusion ===\\n";\nrequireFile("config.php");\necho "Configuration: " . $config["site_name"] . " v" . $config["version"] . "\\n";\necho "Base de donnees: " . $config["db_host"] . "/" . $config["db_name"] . "\\n";\n\n// Difference entre require et include\necho "\\n--- Test avec fichier inexistant ---\\n";\necho "include (avertissement uniquement): OK\\n";\necho "require (erreur fatale si fichier manquant): OK\\n";\n?>`,
      exerciseEn: `<?php\n// Exercise 12: require() & include()\n// Simulate file inclusion\n\n// TODO: Create a simulated config file\n$config = [\n    "site_name" => "MySite",\n    "db_host" => "localhost",\n    "db_name" => "mydb",\n    "version" => "1.0"\n];\n\n// Simulate require\nfunction requireFile($file) {\n    echo "Loading: " . $file . "\\n";\n    return true;\n}\n\n// Simulate include\nfunction includeFile($file) {\n    echo "Including: " . $file . "\\n";\n    return true;\n}\n\n// Test inclusions\necho "=== Inclusion Test ===\\n";\nrequireFile("config.php");\necho "Config: " . $config["site_name"] . " v" . $config["version"] . "\\n";\necho "Database: " . $config["db_host"] . "/" . $config["db_name"] . "\\n";\n\n// Difference between require and include\necho "\\n--- Test with non-existent file ---\\n";\necho "include (warning only): OK\\n";\necho "require (fatal error if file missing): OK\\n";\n?>`,
      exerciseAr: `<?php\n// التمرين 12: require() و include()\n// محاكاة تضمين الملفات\n\n$config = [\n    "site_name" => "موقعي",\n    "db_host" => "localhost",\n    "version" => "1.0"\n];\n\necho "=== اختبار التضمين ===\\n";\necho "تحميل: config.php\\n";\necho "الإعدادات: " . $config["site_name"] . " v" . $config["version"] . "\\n";\n?>`,
    },
    13: {
